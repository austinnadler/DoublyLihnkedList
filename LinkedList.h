...
class LinkedList
{
  ...
  public:
    ...
    void pushAt(const int index, const E &element)
    {
        ...
        {
            throw std::logic_error("Error in pushAt(" + std::to_string(index) + "): Invalid index");
        }
        if (index == 0)
        {
            pushFront(element);
    ...
    E popBack()
    {
        if (isEmpty())
        {
            throw std::logic_error("Error in popBack(): The list is empty");
        }
    ...
    E popAt(const int index)
    {
        if (numberOfNodes == 0)
        {
            throw std::logic_error("Error in popAt(" + std::to_string(index) + "): The list is empty");
        }
        if (index < 0 || index >= numberOfNodes)
        {
            throw std::logic_error("Error in popAt(" + std::to_string(index) + "): Invalid index");
        }
        if (index == 0)
        {
            return popFront();
    ...
    E getAt(const int index)
    {
        if (isEmpty())
        {
            throw std::logic_error("Error in getAt(" + std::to_string(index) + "): The list is empty");
        }
        if (index < 0 || index >= numberOfNodes)
        {
            throw std::logic_error("Error in getAt(" + std::to_string(index) + "): Invalid index");
        }
        if (index == 0)
        {
            return getFront();
    ...
    void setAt(const int index, const E &element)
    {
        if (isEmpty())
        {
            throw std::logic_error("Error in setAt(" + std::to_string(index) + ", " + std::to_string(element) + "): The list is empty. Use push(arg) or another push method");
        }
        if (index < 0 || index >= numberOfNodes)
        {
            throw std::logic_error("Error in setAt(" + std::to_string(index) + ", " + std::to_string(element) + "): Invalid index ");
        }
        if (index == 0)
        {
            setFront(element);
    ...
    void deleteAt(const int index)
    {
        if (isEmpty())
        {
            throw std::logic_error("Error in setAt(" + std::to_string(index) + "): The list is empty");
        }
        if (index < 0 || index >= numberOfNodes)
        {
            throw std::logic_error("Error in deleteAt(" + std::to_string(index) + "): Invalid index");
        }
        if (index == 0)
        {
            deleteFront();
